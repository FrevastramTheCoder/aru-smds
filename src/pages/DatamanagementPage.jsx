...
//   // ✅ Save all layers to Database (with backend error detail)
...
//         formData.append(
//           "file",
//           new Blob([JSON.stringify(layer.data)], {
...
//         } else {
//           const msg =
//             res.data?.error || res.data?.detail || "Unknown server error";
...
//   // ✅ Restore layers from storage on reload
//   useEffect(() => {
...
//             Upload
//           </button>
//           <button style={btnGreen} onClick={handleSaveAllLayers}>
//             Save
//           </button>
...
// // export default DataManagement;// src/pages/DataManagement.jsx
// import React, { useRef, useState, useEffect } from "react";
// import axios from "axios";
// import { useAuth } from "../context/AuthContext";
// import {
...
//   const buttonBase = { color: "#fff", padding: "10px 16px", borderRadius: 10, fontWeight: 700, border: "none", cursor: "pointer", marginRight: 10, minWidth: 140, marginBottom: 8 };
//   const btnYellow = { ...buttonBase, backgroundColor: "#f59e0b" };
//   const btnGreen = { ...buttonBase, backgroundColor: "#22c55e" };
//   const btnRed = { ...buttonBase, backgroundColor: "#ef4444" };
//   const btnGray = { ...buttonBase, backgroundColor: "#6b7280" };
...
//         <MapContainer
//           whenCreated={(map) => (mapRef.current = map)}
//           center={[-6.8161, 39.2831]} // Ardhi University Dar es Salaam
//           zoom={16}
//           style={{ height: "100%", width: "100%" }}
//         >
//           <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" attribution="© OpenStreetMap contributors" />
...
//         <MapContainer
//           whenCreated={(map) => (mapRef.current = map)}
//           center={[-6.766343604847908, 39.21384585200582]} // Initial camera coordinates
//           zoom={16}
//           style={{ height: "100%", width: "100%" }}
//         >
//           <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" attribution="© OpenStreetMap contributors" />
