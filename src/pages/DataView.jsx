...
function DataView() {
  ...
  // Default layer colors (same as MapView)
  ...
  const getLayerColor = useCallback((layer) => {
    return customColors[layer] || defaultLayerColors[layer] || '#000000';
  }, [customColors]);
  ...
  const pageButtonStyle = { padding: "8px 12px", borderRadius: 6, border: "1px solid #d1d5db", backgroundColor: "#fff", cursor: "pointer" };
  const activePageButtonStyle = { ...pageButtonStyle, backgroundColor: "#3b82f6", color: "#fff" };
  const colorPickerContainer = { marginBottom: 20, padding: 15, backgroundColor: "#f0f9ff", borderRadius: 8, border: "1px solid #bae6fd" };
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={colorPickerContainer}>
        <h3 style={{ margin: "0 0 10px 0", color: "#0369a1" }}>Layer Color</h3>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <div
            style={{
              width: '30px',
              height: '30px',
              backgroundColor: getLayerColor(layerName),
          ...
          <input
            type="color"
            value={getLayerColor(layerName)}
            onChange={(e) => handleColorChange(layerName, e.target.value)}
            style={{ width: '50px', height: '30px', padding: '0', border: 'none' }}
          />
          <button
            onClick={() => resetColor(layerName)}
            style={{
              padding: '8px 12px',
            ...
            disabled={!customColors[layerName]}
          >
            Reset to Default
          </button>
        </div>
