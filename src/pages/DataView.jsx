...
function DataView() {
  ...
  // Debug function to check why layerName is undefined
  useEffect(() => {
  ...
  const fetchData = async (page = 1, elementType = "all") => {
    ...
    if (!layerName || layerName === "undefined") {
      ...
      toast.error("No layer specified. Please navigate to this page with a valid layer name.");
      return;
    }
    ...
    try {
      ...
      if (res.data && res.data.success) {
        const rows = res.data.data.map((r) => {
          const attributes = r.attributes || {};
          const geometry = r.geometry || {};
          const elementType = r.elementType || attributes.type || attributes.feature_type || layerName || "unknown";
          ...
          return {
            ...
            geometry,
            elementType,
            color: getLayerStyle(layerName, elementType).color,
          };
        });
    ...
    return (
      <div style={containerStyle}>
        ...
        <div style={{ textAlign: "center", padding: 40, color: "#ef4444" }}>
          <h3>No layer specified</h3>
          <p>Please navigate to this page with a valid layer name in the URL.</p>
          <p>Example: /data-view/buildings</p>
          <button 
